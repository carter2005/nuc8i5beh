...
cp -r ./OpenCore/X64/EFI/OC/Drivers/AudioDxe.efi ./Components/OC/
cp -r ./OpenCore/X64/EFI/OC/Drivers/CrScreenshotDxe.efi ./Components/OC/
...
cp -r ./OpenCore/X64/EFI/OC/Drivers/AudioDxe.efi ./EFI/OC/Drivers/
cp -r ./OpenCore/X64/EFI/OC/Drivers/CrScreenshotDxe.efi ./EFI/OC/Drivers/
